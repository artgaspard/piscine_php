...
if ($_POST['addprod'] != NULL && $_POST['choosecat'] != NULL && $_POST['choosecat'] != NULL && $_POST['sales'] != NULL && $_POST['id'] != NULL && $_POST['url'] != NULL && $_POST['description'] != NULL && $_POST['price'] != NULL && $_POST['subaddprod'] == "ADD")
{
	$newprod = array('item' => $_POST['addprod'], 'type1' => $_POST['choosecat'], 'type2' => $_POST['sales'], 'id' => $_POST['id'], 'picture' => $_POST['url'], 'carac' => $_POST['description'], 'price' => $_POST['price']);
	$prod[] = $newprod;
...
<html><body>
	...
	<br />
	Category: <input list="browser" type="text" name="choosecat" value=""/>
	<datalist id="browser">
	</datalist>
	<br />
	<br />
